...
var Drawing = (function() { // Drawing in Canvas
    ...
    var Drawing = function(htOption) {
        ...
        this._elCanvas = Canvas.createCanvas(htOption.size, htOption.size);
    ...
    Drawing.prototype.draw = function(oQRCode) {
        ...
        var _tCanvas = Canvas.createCanvas(size, size);
        ...
        var _bkgCanvas = Canvas.createCanvas(size, size);
        ...
        if (_htOption.backgroundImage !== undefined) {
            ...
            if (false && _htOption.maskedDots) {
                _maskCanvas = Canvas.createCanvas(size, size);
        ...
        var _fCanvas = Canvas.createCanvas(rawSize, rawSize); //document.createElement("canvas");
